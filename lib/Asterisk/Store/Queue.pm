...
Number of abandoed calls queue has seen
...
Queue members -- An array of L<Asterisk::Store::Queue::Member> objects
...
Logs end up in the log/ subdirectory from the current working directory.
...
Derek Carter, E<goozbach@neverblock.com>
